...
#define NSS SS                                  //SX128X device select
...
const uint32_t Frequency = 2480000000;           //frequency of transmissions in hz
...
const uint16_t Calibration = 10260;              //Manual Ranging calibrarion value
